...
const PROFILE = {
  ...
  updated: "CV Updated: February 12, 2026",
};
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem asChild>
                <a href={LINKS.email} className="text-black hover:text-black hover:scale-105 transition transform">
                  <Mail className="mr-2 h-4 w-4" /> Email
                </a>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <a href={LINKS.cv} target="_blank" rel="noreferrer" className="text-black hover:text-black hover:scale-105 transition transform">
                  <FileText className="mr-2 h-4 w-4" /> CV (PDF)
                </a>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <a href={LINKS.googlescholar} target="_blank" rel="noreferrer" className="text-black hover:text-black hover:scale-105 transition transform">
